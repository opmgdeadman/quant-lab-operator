...
async function statusPayload(env) {
  const [dbProbe, dataHealth, paperAccount, baselineBench, hostileJudge, strategyFactory, championSelection, forwardOperation, liveQualification, rollingResearch] = await Promise.all([
    databaseProbe(env),
